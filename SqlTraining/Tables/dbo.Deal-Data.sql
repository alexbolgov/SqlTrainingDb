...
(
	...
	from (
		...
		('2017-04-05','2017-05-09','EKS_RETAILLOANS','ret-20170405','OFF36','A_RETAIL_MORT','USD',null,'100000','2017-04-05','2017-04-05','2027-04-05','100000','0','0.05','1M'),
	...
	) vals(ValidFrom, ValidTo, SourceSystemName, SourceSystemRecordNumber, OrgUnitCode, ProductCode, CCY, ClientID, OriginalTotalPrincipal, DealDate, ValueDate, MaturityDate, CurrentPrincipal, PastDueAmount, CurrentInterestRate, InterestPaymentFrequency) 
)
